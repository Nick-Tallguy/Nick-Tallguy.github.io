...
permalink: /zh_TW/osm-data/postgresql/
lang: zh_TW
category: osm-data
---
...
> 此指南能以 [PostgreSQL_zh_TW.odt](/files/PostgreSQL_zh_TW.odt) 或 [PostgreSQL_zh_TW.pdf](/files/PostgreSQL_zh_TW.pdf) 下載  
> 審閲於 2016-09-10
...
-	打開 QGIS 然後按下這個 ![qgis add postgis button][]{: height="24px"} 按鈕。  
