...
نقشه‌کشی از راه دور و جایگاه آن در تیم انسان‌دوستانه
==================

> این راهنما را می‌توان به صورت [remote_fa.odt](/files/remote_fa.odt) و یا [remote_fa.pdf](/files/remote_fa.pdf) دانلود کرد.  
...
- تهیه منبع و آماده‌سازی تصاویر ماهواره‌ای،  
