---
layout: doc
title: Збереження — коментар до набору змін та завершення квадрата в диспетчері завдань, редактор iD
permalink: /uk/hot-tips/saving/
lang: uk
category: hot-tips
---

Збереження — коментар до набору змін та завершення квадрата в диспетчері завдань, редактор iD
============
...
Редактор iD — збереження
------------------

### Основні принципи збереження за допомогою редактора iD ###
