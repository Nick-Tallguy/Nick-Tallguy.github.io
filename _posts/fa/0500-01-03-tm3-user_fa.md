...
هنگامی که یک پروژه را برای کار روی آن پیدا کردید، با کلیک بر روی عنوان پروژه، به ورودی دقیق آن پروژه می‌روید. این نمای تفصیلی شامل:
...
چند توصیه کلی که هنگام کار با این ابزار باید به آنها توجه کرد:  
...
با کلیک بر روی دکمه "شروع اعتبارسنجی" تمام کارهای تکمیل شده توسط آن نقشه‌بردار قفل می‌شود و به اعتباردهنده اجازه می‌دهد آنها را در ویرایشگر انتخابی خود باز کند.
