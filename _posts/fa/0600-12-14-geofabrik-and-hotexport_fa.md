...
لطفاً توجه داشته باشید که تقریباً همیشه نوعی پالایش لازم است، درغیراین‌صورت theme به‌سادگی تمام عارضه‌های OSM برای انواع هندسه‌های انتخابی را شامل می‌شود. هر پالایه با استفاده از نحوِ شبه-SQL مشخص می‌شود. با کلیدواژه‌های معتبر IS NOT NULL،‏ AND،‏ OR،‏ IN،‏ =،‏ <span dir="ltr">!=</span>.
