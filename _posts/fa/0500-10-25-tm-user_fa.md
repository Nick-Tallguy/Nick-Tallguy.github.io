...
- **More filters** - allows you to filter by;
  ...
  - موقعیت
  - علایق
 - همچنین می‌توانید فهرست نتایج را مرتب کنید
...
- جاده‌ها: اغلب برای مسیریابی در دستگاه‌های ناوبری استفاده می‌شوند.
- ساختمان‌‌ها: می‌تواند جهت دانستن محل‌هایی که مردم زندگی می‌کنند و یا اینکه تحت تاثیر آنهاست استفاده می‌شود.
- راههای آبی: برای ارزیابی خسارت یا ردیابی تماسی بیماریها مفیدند
...
#### انتخاب یک وظیفه برای کشیدن نقشه
...
##### بازکردن قفل یک وظیفه قبل از تکمیل شدن
{:.no_toc}
