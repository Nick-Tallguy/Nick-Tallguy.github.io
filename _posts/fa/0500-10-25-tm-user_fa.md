---
layout: doc
title: راهنمای مدیر وظایف نقشه‌کش
permalink: /fa/coordination/tm-user/
lang: fa
category: coordination
---

# راهنمای مدیر وظایف نقشه‌کش


**چنانچه رابط کاربری نگارش شما با آنچه که در اینجا شرح داده شده است متفاوت می‌باشد می‌بایست مشاوره بگیرید [کلیات نگارش ما](/fa/coordination/tm-disambiguation)**

- TOC
{:toc}

مدیر وظایف عمومی‌ترین ابزار برای تیم سازی و هماهنگ کردن نقشه‌کشی در OpenStreetMap است.

> OpenStreetMap.org یک نقشه مبتنی بر همکاری، جمعیت منبع، رایگان و آزاد از جهان است. هرکسی می‌تواند در OpenStreetMap مشارکت کند تا نقشه هر قسمت از جهان را که تمایل دارد رسم کند.

شما به طرز گسترده‌ای می‌توانید از [مدیر وظایف HOT](http://tasks.hotosm.org) برای شروع به نقشه‌کشی فوری برای سازمانهای بشردوستانه استفاده کنید تا آنها کار را در آن منطقه شروع کنند.
...
* OpenStreetMap.org - پایگاه داده اطلاعات جغرافیایی
* مدیر وظایف - ابزار هماهنگ کردن نقشه‌کشی در یک منطقه روی داده‌های OpenStreetMap است
* یک ویرایشگر OpenStreetMap - برنامه نرم‌افزاری است که می‌تواند داده درون پایگاه داده OpenStreetMap را بخواند و در آن بنویسد
...
- پروفایل مدیر وظایف خود را ببینید
- آدرس ایمیل و رابط‌های شبکه‌های اجتماعی‌تان را به روز کنید
- ویرایشگر منتخب خود را انتخاب کنید
- سطح تجربه نقشه‌کشی خود را ببینید
- نوع پروژه‌ای را که بیشتر به آن علاقه دارید انتخاب کنید
- فهرستی از پروژه‌هایی که در آن مشارکت کرده‌اید را ببینید
- انتخاب کنید که جه اعلانهایی برایتان ارسال شود
- خروج از سیستم
...
- **More filters** - allows you to filter by;
  ...
  - سازمان
  - موقعیت
 - همچنین می‌توانید فهرست نشان داده شده را مرتب کنید
...
نمادها انواع نقشه‌کشی را نشان میدهند، مانند:

- جاده‌ها: اغلب برای دستگاه‌های ناوبری استفاده می‌شوند.
- Buildings: Can be used to understand where people live and might be impacted.
- راه‌های آبی: برای ارزیابی میزان آسیب و یا ردیابی تماس با بیماری مفید هستند.
- Land use: Understand the purpose of land is part of a comprehensive map.
- سایر: هر نوع دیگر نقشه.
...
- آبی کمرنگ - آماده صحت‌سنجی
- زرد - نیاز به نقشه‌کشی بیشتر دارد
- سبز - نقشه‌کشی شده و صحت‌سنجی شده است - به کار دیگری نیاز ندارد
- مربع‌های خاکستری در دسترس نیستند
- مربع‌های صورتی نشان دهنده مناطق با اولویت بالاتر هستند و
