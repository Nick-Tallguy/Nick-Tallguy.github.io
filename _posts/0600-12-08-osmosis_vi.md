...
You will also need some raw OSM data to work with. If you want to follow the examples in this chapter, download our sample file [tại đây](/files/sample_osmosis.osm.pbf). You may also use a raw data file of your choosing.  
