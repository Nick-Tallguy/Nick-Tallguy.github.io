...
![TM Map a Task][]{:style="float:left;height:50px"} El botón `Mapear una tarea` bloqueará una tarea aleatoria para usted, y es la mejor opción a elegir cuando se mapea en una Mapatón, o cuando un gran número de personas están trabajando en un proyecto al mismo tiempo.
