...
Haga clic en Aceptar. Si todo ha ido bien, debería ver su Documento de Campo cargado en JOSM. Para saber cómo añadir los lugares que has mapeado en OpenStreetMap, consulta [el proceso de edición de JOSM](/es/josm/more-about-josm) y [editing field data](/es/josm/editing-with-josm).  
