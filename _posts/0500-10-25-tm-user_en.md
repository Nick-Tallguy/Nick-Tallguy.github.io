...
Section Index
-------------
-  [Quick Start Guide](/en/coordination/tm-user/#quick-start-guide)  
-  [The Mapping Process](/en/coordination/tm-user/#mapping-process)  
    -  [Logging in](/en/coordination/tm-user/#tasking-manager-login)  
    -  [Options - language settings and user profile](/en/coordination/tm-user/#options-amp-links)  
    -  [Finding a Project - list based and using a map view, searching and filtering](/en/coordination/tm-user/#finding-a-project---tasking-manager-contribute-screen)  
    -  [Mapping a Task - select, work on and unlock a task](/en/coordination/tm-user/#mapping-via-the-tasking-manager) 
-  [Getting Help - live and contacting the project administrator](/en/coordination/tm-user/#getting-help)  
-  [Hints and Tips](/en/coordination/tm-user/#editing-hints-and-tips)  
-  [Validation](/en/coordination/tm-user/#validation)
...
The Task Manager initially displays in English - to change to another language click on **English**.

![TM language editor][]{: height="100px"} ![TM personal][]

From the same page you may also;  
...
To view messages and notifications sent to you click on the ![TM notifications][]{: height="23px"} at the top right of the screen. 

### Finding a Project - Tasking Manager Contribute Screen

Clicking on the ![TM Start mapping][]{:height="21px" width="75"} link on the home page will take you to the main list of projects in the Tasking Manager.
