...
![TM history instructions][]{:style="float:right;height:250px"} Once you have locked your Task, if using iD a new tab will have opened with the iD editor loaded, and your square (Task) boundary shown. You can still click on the Tab of your browser containing the Tasking Manager, and you will then see that there are tabs available to you to see;  
...
To get started you select the project you want to work on. In the new page that opens scroll down to the bottom to read the comments for that project so you understand any problems that mappers may be having. Here you can also see the information regarding any teams, permissions and contributors. Then click on the contribute button at the bottom right to move to the next page

On the next page read the instructions to understand what imagery is to be used and what the mappers have been asked to do. This will give you an understanding of why the mappers are mapping the way they do and if the instructions are misleading and the mappers are consistently getting it wrong because of that then you can contact the Project Manager to change the instructions to reduce the effects of that happening.

Select a blue task on the map, select your editor at the bottom of the map then click on the red button Validate selected task. This will take you to the editor to start validating.

![TM select for validation][]

You can also select the Contributions list and select Beginner to see how many and which tasks a beginner has mapped. 
...
Once you have finished your validation check return to the Tasking Manager and you will only have two options at this stage Validate and mark as finished or More mapping is needed. Hopefully we will also get the option to Stop validating if we did not have the time to completely validate the whole task.
