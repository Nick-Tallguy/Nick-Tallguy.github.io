...
![TM history instructions][]{:style="float:right;"} Once you have locked your Task, if using iD a new tab will have opened with the iD editor loaded, and your square (Task) boundary shown. You can still click on the Tab of your browser containing the Tasking Manager, and you will then see that there are tabs available to you to see;  
