---
layout: doc
title: دليل مخطط إدارة المهام
permalink: /ar/coordination/tm-user/
lang: ar
category: coordination
---

# دليل مخطط إدارة المهام


**إذا كانت واجهة المستخدم للإصدار الذي تستخدمه تبدو مختلفة عن تلك الموصوفة هنا، فيجب عليك استشارة [نظرة عامة على الإصدار الخاص بنا] (/ar/cordination/tm-disbulation) **

- TOC
{:toc}

مدير المهام هو الأداة الأكثر شعبية لتجميع وتنسيق رسم الخرائط على OpenStreetMap.

> OpenStreetMap.org هي خريطة تعاونية، انسانية المصدر، ومجانية للعالم. يمكن لأي شخص المساهمة في OpenStreetMap لرسم خريطة أي جزء يهمهم من العالم.
...
* محرر OpenStreetMap - برنامج برمجي يمكنه قراءة البيانات وكتابتها في قاعدة بيانات OpenStreetMap
...
1. A new tab will open allowing you to register on OpenStreetMap.org. Provide your account information and press the `Sign up` button at the bottom of the form.
  ![TM4-user-guide-3][]
1. أغلق صفحة التبويب ثم ارجع إلى [إدارة المهام] (http://tasks.hotosm.org/). انقر على الزر لـ `تسجيل الدخول`.
  ![TM4-user-guide-4a][]
  ![TM4-user-guide-4b][]
1. حدد `Explore projects` في التنقل الرئيسي للعثور على مشروع لتعيين الخريطة عليه.
  ![TM4-user-guide-5][]
1. اقرأ مقدمة المشروع وانقر على `مساهمة` للبدء بمهمة رسم الخرائط.
  ![TM4-user-guide-6][]
1. تعيين مهمة مختارة عشوائيا لرسم الخرائط من خلال النقر على الزر `تعيين مهمة `.
  ![TM4-user-guide-7][]
...
- تحديث عنوان بريدك الإلكتروني ومقابض وسائل التواصل الاجتماعي
- حدد محرر الخلاائط المفضل لديك
- عرض مستوى تجربتك في تخطيط الخرائط
