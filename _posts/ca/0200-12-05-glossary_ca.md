...
**3W** : ¿Qui, què, on (en anglès: who, what, where) fa què, on?  
...
**TIGER**: una font de dades del «US Census Bureau» que fou importada a l'OSM, el 2007. Aquesta és la font principal de dades als EUA per a l'OSM.

**Tessel·la* (en anglès, «tile»): una imatge petita(256x256 píxels ) de dades del mapa renderitzades.
