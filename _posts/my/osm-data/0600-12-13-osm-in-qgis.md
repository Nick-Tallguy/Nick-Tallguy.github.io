...
အခန်းရှိ[Getting OSM Data](/en/osm-data/getting-data) နှင့် [Using Geofabrik and HOT Export](/en/osm-data/geofabrik-and-hot-export) တို့တွင်ဖော်ပြခဲ့သကဲ့သို့  ပိုမိုကြီးမားသောဒေတာset များကိုရယူရန်နည်းလမ်းမြောက်များစွာ ရှိပါသည်။  
