...
OpenStreetMap တွင်မြေပုံရေးဆွဲရာ၌ အမှတ်(nodes)၊ မျဉ်းကြောင်းများ(lines) နှင့် ဗဟုဂံပုံ(closed ways) ဟူသောအမျိုးအစား ၃ မျိုးအကြောင်းကို [စတင်အသုံးပြုသူအတွက် လမ်းညွှန်](/my/beginner) အပိုင်းတွင်ရှင်းလင်းခဲ့ပြီးဖြစ်သည်။ မျဉ်းကြောင်းများတွင် အမှတ်များလည်းပါဝင်ပြီး ကိုယ်စားပြုဖော်ပြချက်များလည်းသတ်မှတ်ထားနိုင်သည်။ ဗဟုဂံပုံများသည်မျဉ်းကြောင်းများပင်ဖြစ်ပြီး အစမှတ်နှင့်အဆုံးမှတ် တထပ်တည်းကျနေသောမျဉ်းကြောင်းကပုံသဏ္ဍာန်တခုအဖြစ်ပုံဖော်ပေးထားသည်။  

ထို့အပြင် Relations ဟုခေါ်သော အမျိုးအစားတခုကိုလည်း OpenStreetMap မြေပုံများတွင်တွေ့မြင်နိုင်သည်။ မျဉ်းကြောင်းများအပေါ်တွင်အမှတ်များပါလေ့ရှိသကဲ့သို့ 
Relation တခုတွင်လည်း အမှတ်၊မျဉ်းကြောင်းနှင့် ဗဟုဂံပုံစသည့် အစုအဝေးများပါဝင်နိုင်ပါသည်။ မြေပုံရေးဆွဲမှုစွမ်းရည်တိုးတက်လိုပါက relations များကို ပြုပြင်တည်းဖြတ်ခြင်းကိုလည်းနားလည်သိရှိရန်လိုအပ်သည်။  

ဥပမာ.. အလယ်တွင်ကွက်လပ်ချန်လျှက်လေးဘက် လေးတန်ကာရံဆောက်လုပ်ထားသော အဆောက်အဦကိုမြေပုံထုတ်သည်ဆိုပါစို့။ အဆောက်အဦ၏အပြင်ဘက်အနားကို ခြုံငုံမိသောဗဟုဂံပုံတခုနှင့် အလယ်ကွက်လပ်ကိုကန့်သတ်ပြထားသောဗဟုဂံပုံများလိုအပ်မည်။ သို့မှသာယင်းကွက်လပ်ကို အဆောက်အဦ၏အစိတ်အပိုင်းတွင်မပါဝင်ကြောင်း ညွန်ပြနိုင်မည်ဖြစ်၏။ ထိုသို့ရေးဆွဲထားခြင်းကို relation ဟုသတ်မှတ်သည်။ Relation တွင် ဗဟုဂံပုံများစွာပါဝင်နိုင်ပြီး အဆောက်အဦ၏သတ်မှတ်ဖော်ပြချက်များကို ဗဟုဂံပုံများတွင်မဟုတ်ဘဲ relation တခုလုံးနှင့်တွဲစပ်ပေးရမည်။  
...
- ပုံသဏ္ဍာန်တခုကို ဦးစွာရေးဆွဲပါ။ ယခုဥပမာတွင် ထောင့်မှန်စတုဂံ ၃ ခုကိုရေးဆွဲပါမည်။ အောက်ပါပုံတွင် ကြည့်ပါ။

![Multipolygon ways][]

- ကွန်ပျူတာကီးဘုတ်မှ SHIFT ခလုတ်ကိုဖိလျှက် ပုံများကိုတခုချင်းစီနှိပ်၍ရွေးချယ်ပါ။  
...
- ထို့နောက် **အပိုင်း၊ကဏ္ဍ (roles)** ဖော်ပြပေးရန်လိုအပ်သည်။ Relation တွင်ပါဝင်သောအဖွဲ့ဝင်တိုင်းတွင် မည်သည့်အပိုင်း၌ပါဝင်ကြောင်းဖော်ပြသည့် role ပါရှိသည်။ ယခုပုံတွင် အပြင်ပိုင်းတွင်ရှိသော ထောင့်မှန်စတုဂံပုံအတွက်  **outer ** ဟု သတ်မှတ်၍ အတွင်းပိုင်းရှိ ထောင့်မှန်စတုဂံ အသေးနှစ်ခုကို **inner** ဟုသတ်မှတ်ပါ။ ယင်းတို့မှာ ဗဟုဂံပုံအမျိုးမျိုးတွင်ပါဝင်သောပုံများအတွက်သတ်မှတ်ပေးနိုင်သော roles အမျိုးအစားများပင်ဖြစ်သည်။  
- ဘယ်ဘက်အောက်နားရှိ အကွက်တွင်ပါ၀င် သည့်အရာများကိုတခုစီရွေးချယ်ကြည့်ပါ။ ရွေးချယ်လိုက်သောအရာကို ကိုယ်စားပြု သည့်မြေပုံပေါ်ရှိရုပ်ပုံတွင်အထူးပြုဖော်ပြချက်ဖြစ်ပေါ်လာမည်ဖြစ်ပြီး  **inner ** နှင့်  **outer ** ရွေးချယ်မှုကိုမှန်ကန်စွာပြုလုပ်နိုင်မည်ဖြစ်သည်။  

![Outer or inner role][]

- မှန်ကန်မှုရှိပါက OK ကိုနှိပ်ပါ။ ဗဟုဂံပုံအမျိုးမျိုးပါဝင်သော relation ဖန်တီးမှုပြီးမြောက်ပြီဖြစ်သည်။  

![New multipolygon][]

ထိုသို့သော ဗဟုဂံပုံအမျိုးမျိုးကိုဖန်တီးပြီးပါကမြေပုံပေါ်တွင် အောက်ဖော်ပြပုံအတိုင်းတွေ့မြင်ရမည်ဖြစ်သည်။  
...
JOSM ဆော့ဖ်ဝဲလ်တွင် ဘတ်စ်ကားလမ်းကြောင်းပြမြေပုံတခုရေးဆွဲခြင်းကိုလေ့လာကြည့်ပါမည်။  

- ပြေးဆွဲသောလမ်းကြောင်းများကို ဦးစွာရွေးပါ။ လမ်းကြောင်းပေါ်သို့တစိတ်တပိုင်းသာပါဝင်သောလမ်းများတွင် "Split Way" ကိရိယာကိုအသုံးပြု၍စိစစ်ခွဲခြားပါ။  
...
- "New Relation" တွင်ကလစ်နှိပ်ပါ။ ဗဟုဂံပုံအမျိုးမျိုးစုဖွဲ့ခြင်းမှာကဲ့သို့ မျက်နှာပြင်တခုထပ်မံထွက်ပေါ်လာသည်ကိုမြင်ရမည်။  

![Bus route relation][]

- *type=multipolygon* အစား *type=route* ဟုဖော်ပြထားသော အညွှန်းတခုမှတ်သားပြီးဖြစ်သည်ကိုသတိပြုပါ။ အခြားသောလမ်းကြောင်းများနှင့်ကွဲလွဲမှုရှိစေရန် ဘက်စ်ကားလမ်းကြောင်းဖြစ်သည်ကိုခွဲခြားဖော်ပြသည့် အညွှန်းတခုလည်းတွေ့ရမည်ဖြစ်သည်။  
- ပါဝင်သည့်လမ်းပိုင်းများ၏**အခန်းကဏ္ဍ(role)** ကိုစဉ်းစားရန်အပိုင်းသို့ရောက်လာပါပြီ။ ယခုအပိုင်းသည် လမ်းကြောင်းတခုကို ဖော်ပြသည့်အတွက် အတွင်း၊အပြင်ပိုင်းများကိုသတ်မှတ်ဖော်ပြရန်မလိုပေ။ လမ်းကြောင်းတခု၏အစိတ်အပိုင်းအဖြစ်ဆော့ဖ်ဝဲလ်မှသိရှိနိုင်ပါသည်။ လမ်းပိုင်းတခုစီ၏ role ကို **route** အဖြစ်ဖော်ပြပေးနိုင်သော်လည်း ထိုသို့ပြုလုပ်ပေးရန်မလိုပေ။  
- ထို့နောက် OK ကိုနှိပ်ပါ။ လမ်းကြောင်းများစုဖွဲ့မှုကိုပြသော relation ပြုလုပ်မှုပြီးမြောက်ပြီဖြစ်သည်။  
...
Relations များသည် နားလည်ရခက်ပြီး မကြာခဏအသုံးပြုရခြင်းမျိုးလည်းမရှိချေ။ သို့သော်နားလည်ထားရန်လိုအပ်ပေသည်။ မြေပုံရေးဆွဲရာတွင် relations အသုံးပြုရန်လိုအပ်လာပါက ယခုလေ့လာ ထားသည်များကို ပြန်လည်အသုံးချနိုင်ရန်အတွက်ရည်ရွယ်ပါသည်။ OSM Wiki တွင်ဖော်ပြထားသော အချက်အလက်များကသင့်ကို ကူညီထောက်ပံ့ပေးပါလိမ့်မည်။
