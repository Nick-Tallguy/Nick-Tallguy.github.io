...
نقشه‌کشی با استفاده از GPS گارمین
====================
...
فراکیری ویرایش نقشه از کلیدی‌ترین مسائل کار با نقشه است - با آن 
...
که دستگاه GPS کار می‌کند و چگونه بوسیله آن می‌توان نقشه را ایجاد کرد.
