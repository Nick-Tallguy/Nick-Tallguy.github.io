...
Nesta secção aprenderemos passo a passo como navegar no
site do OpenStreetMap, ver mapas e criar uma conta
de utilizador. Após criar a conta com o nome e palavra-chave, poderá
contribuir com os seus primeiros pontos no mapa.
...
-   Antes de começar, certifique-se se o seu computador está ligado à internet.
    (Se está a ler isto online então deve estar ligado!)
-   Abra o seu programa de navegação de internet, como o Firefox, Chrome, Opera, ou o Internet
    Explorer. Se já estiver aberto basta abrir uma nova aba ou janela no navegador.
-   Na barra de endereços no topo da janela, introduza o seguinte endereço e carregue na tecla Enter:
    [www.openstreetmap.org](http://www.openstreetmap.org/)
-   Quando a página estiver carregada, deverá ver algomo como
    isto:
...
-   A principal coisa que deve ver é o mapa. Mova o mapa clicando
    nele com o botão esquerdo do rato, mantendo premido o botão e
    arrastando o rato (ver imagem abaixo).

    ![Mouse navigation][]

-   Se tiver um rato com um botão de roda deslizante pode usá-la para aproximar ou afastar o mapa
