...
> Esta guía puede ser descargada como [josm_editing-with-josm_es.odt](/files/josm_editing-with-josm_es.odt) o [josm_editing-with-josm_es.pdf](/files/josm_editing-with-josm_es.pdf)  
> Revisado 2015-07-13  
...
Capas de JOSM
-----------
Si has llegado hasta aquí, te habrás dado cuenta que podemos añadir todo tipo
de cosas diferente en JOSM. Podemos descargar datos de OSM, añadir imágenes satélite de Bing,
cargar pistas GPS y puntos de vías, y añadir Papeles de Campo - todos ellos son mostrados
en la ventana de mapa de JOSM
...
-------------------------------
En el capítulo [Mapeo con un Smartphone, GPS o papel] vimos cómo recoger los datos con un GPS (/es​​/mobile-mapping/)
