...
- [Mirrored Download]({{site.baseurl}}/en/beginner/josm-plugins/#mirrored-download) (permite descarregar mais dados OSM)
- [Direct Upload]({{site.baseurl}}/en/beginner/josm-plugins/#direct-upload) (permite enviar trilhos GPS)
- [Editgpx]({{site.baseurl}}/en/beginner/josm-plugins/#edit-gpx) (permite editar trilhos GPX)
