...
### آپلود چندضلعی
دو روش آخر که در آن یک AOI را می‌توان انتخاب کرد، از طریق ابزار 'این نما' (This View) در سمت راست نقشه است که محدوده نمای فعلی نقشه را دریافت می‌کند، یا با ابزار 'وارد کردن' (Import) که شما را قادر می‌سازد تا چندضلعی منطقه را آپلود کنید، انجام می‌شود.  
