...
permalink: /it/coordination/tasking-manager/
lang: it
...
-------------
-  [Introduzione a come HOT usa il Tasking Manager](/it/coordination/tasking-manager/#overview-of-the-process)  
- [Lingue, opzioni, collegamenti d'aiuto ed altri link. La tua pagina utente - lista di progetti che hai aiutato, e messaggi](/it/coordination/tasking-manager/#options-amp-links)  
-  [Autenticazione](/it/coordination/tasking-manager/#getting-started-with-the-tasking-manager)  
-  [Trovare un progetto](/it/coordination/tasking-manager/#locating-a-project)  
-  [Descrizione, griglia della mappa, istruzioni, contribuire, attività, statistiche di un progetto](/it/coordination/tasking-manager/#description)  
...
La lista aggiornata dei progetti può essere ordinata per:  
...
Questa scheda mostra le attività che si sono svolte all'interno del task in ordine cronologico.  
