...
1. Už máte účet na OpenStreetMap? Pak můžete přeskočit na krok číslo 4. Jinak klikněte na tlačítko `Sign up` v pravém horním rohu domovské stránky [Tasking Manageru](http://tasks.hotosm.org/).
  ![TM4-user-guide-1][]
1. Budete dotázáni na uvedení vašeho jména a e-mailové adresy.
  ![TM4-user-guide-2a][]
  ![TM4-user-guide-2b][]
1. Otevře se nová karta, která vám umožní zaregistrovat se na OpenStreetMap.org. Zadejte informace o svém účtu a stiskněte tlačítko `Sign up` ve spodní části formuláře. 
  ![TM4-user-guide-3][]
1. Zavřete kartu a přejděte zpět na [Tasking Manager](http://tasks.hotosm.org/). Klikněte na tlačítko `Log in`.
  ![TM4-user-guide-4a][]
  ![TM4-user-guide-4b][]
1. Vyberte `Explore projects` v hlavním menu a vyhledejte projekt ke zmapování.
  ![TM4-user-guide-5][]
1. Přečtěte si úvod k projektu a kliknutím na `Contribute` spusťte mapovací úlohu.
  ![TM4-user-guide-6][]
1. Mapujte náhodně vybranou úlohu pro mapování kliknutím na tlačítko `Map a task`.
  ![TM4-user-guide-7][]
