...
1. Pokud nemáte účet na OpenStreetMap, přejděte na https://openstreetmap.org a vytvořte si ho. To budou přihlašovací údaje, které použijete pro přihlášení do Správce úloh. <br/>
  ![TM Quick Start 1][]
2. Navštivte stránku [http://tasks.hotosm.org/](http://tasks.hotosm.org/) a přihlaste se v pravém horním rohu.  
  ![TM Quick Start 2][]
  > Abyste mohli začít mapovat, musíte ve svém profilu uvést platnou e-mailovou adresu (přístupná přes první položku v nabídce v pravém horním rohu).
...
1. Vzdálený mapper si vytvoří účet v OpenStreetMap a přihlásí se do Správce úloh 3.
...
+ Klikněte na tlačítko "Označit jako kompletně zmapované" a vaše práce je připravena ke kontrole.  
