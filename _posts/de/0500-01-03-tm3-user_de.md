...
Fragen die etwas Nachforschungen oder detaillierte Erklärungen erfordern senden Sie am Besten an mapper-support@hotosm.org

### Direkte Online-Hilfe

1. Melden Sie sich auf slack.hotosm.org an. Dort müssen Sie ein Formular ausfüllen. Es kann einen Moment dauern bis Sie Antwort erhalten.
2. Treten Sie auf Slack dem mapper-support-Kanal bei
...
Alle Kommentare sind öffentlich und es ist kein Live Chat. Verwenden Sie die Slack Option oben, wenn Sie sofortige Aufmerksamkeit benötigen.
