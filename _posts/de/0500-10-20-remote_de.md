...
- [Den Abschnitt über OpenStreetMap.org auf LearnOSM](/de/beginner/start-osm/). Dies deckt nur die Grundlagen über OpenStreetMap, und dies zu lesen wird Ihnen sehr helfen - es ist kein großes Kapitel, daher wird es nicht lange dauern, alles zu lesen. Während Sie es lesen, verwenden Sie die Informationen, die Ihnen dabei helfen, ein OpenStreetMap-Konto zu erstellen und es mit dem E-Mail-Link zu bestätigen. Stellen Sie sicher, dass Sie eine Unterlage mit Ihrem Benutzernamen und Passwort haben.
- [Den Abschnitt über den Tasking Manager auf LearnOSM](/de/coordination/tm-user/). Sie müssen wissen, wie Sie sich am Tasking Manager anmelden, ein bestimmtes Projekt und eine bestimmte Aufgabe wählen und schließlich damit arbeiten können. Sie müssen wirklich das gesamte Dookument lesen!  
...
## Ansicht beim Öffnen des Editors 
### iD
...
## Alternative Ansicht beim Öffnen des Editors 
### iD
...
## Überprüfen der vorhandenen Daten 
### iD
