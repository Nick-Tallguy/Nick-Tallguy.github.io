...
2. Bing ha una considerevole copertura nuvolosa in quest'area.
...
2. Accertati che tutti gli oggetti esistenti che sono visibili anche su Bing siano allineati con esso, oppure riallineali se necessario.
...
Utilizza un linguaggio semplice, chi legge molto spesso non è un madrelingua inglese.

1. Il titolo del progetto dovrebbe già rivelare quale entità dovrà essere mappata. Dovrebbe essere preferibile un titolo come  
...
Rivedi le varie schede per verificare che la grammatica e la formattazione siano corrette e che le istruzioni siano chiare. Se è necessario cambiare o rifinire il progetto, clicca il link 'Edit' nell'angolo in alto a destra della pagina. 
