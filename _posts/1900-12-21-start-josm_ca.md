---
layout: doc
title: Iniciació al JOSM
permalink: /ca/josm/start-josm/
lang: ca
category: josm
published: true
---
...
aprendre algunes de les operacions bàsiques del programa. Recordeu que
...
dibuixar mapes en el JOSM

Baixar el JOSM
-------------

- Si teniu una còpia del JOSM en un CD o una unitat USB, podeu anar
  a la secció següent, Instal·lació del JSOM.
- Si encara no teniu el JOSM, o voleu l'última versió, obriu
  el vostre navegador web, això pot ser el Firefox, Chrom, Opera o Internet
  Explorer.
- En la barra d'adreces de la part superior de la finestra, introduïu
  el text següent i pitgeu Retorn: [josm.openstreetmap.de](http://josm.openstreetmap.de)
- També podeu trobar el lloc web del JOSM cercant a Internet «JOSM».
- El lloc web hauria de ser semblant a això:

  ![JOSM website][]

- Si teniu Windows intal·lat en l'ordinador, feu clic a «Instal·lador del Windows» per a baixar el JOSM.

  ![Windows installer][]

- Si teniu un sistema operatiu diferent,
  feu clic en l'enllaç del vostre sistema. Hauria de començar
  a baixada. En aquest capítol assumirem que esteu emprant Windows,
  però les instruccions són similars per als altres sistemes operatius.

Instal·lació de l'OSM
------------
