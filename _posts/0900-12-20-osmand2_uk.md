...
- Більше інформації про [Налаштування фонового шару](/en/beginner/id-editor/#configuring-the-background-layer) в iD.  
- Більше інформації про JOSM у "[Відкрити в JOSM](/en/mobile-mapping/using-gps/#open-in-josm)"  
