...
This module covers the changing of the shade of the satellite imagery which may make it simpler to pick out details, but also covers installation of the Stylish extension on the [Firefox](/en/hot-tips/enhance/#installing-the-stylish-extension-in-firefox) & [Chrome](/en/hot-tips/enhance/#installing-the-stylish-extension-in-chrome) web browser which allows the installation of different colour schemes, which may assist in your mapping. For instance colouring traced buildings purple when working in an area with red roofed buildings, or another red backround. Other extensions are also available. 
