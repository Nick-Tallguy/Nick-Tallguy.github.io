...
+ In the comment it is possible to address specific mappers by starting with @, following by a OSM user name. Add #contributors, #author or #managers to address these.
