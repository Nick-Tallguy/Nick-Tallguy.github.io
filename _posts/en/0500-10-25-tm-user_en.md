...
Attention: you may need to install a Flash player to use Potlatch.
...
* If you are in doubt about what a particular feature is, use the comment section to ask questions or check the [Map Features wiki](https://wiki.openstreetmap.org/wiki/Map_Features).  
