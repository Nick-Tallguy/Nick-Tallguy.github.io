...
+ Add a comment to the text area detailing what you achieved and more importantly, what you are not certain of. For example; "Complete as far as I can see, but there is cloud covering the top right corner of the task & I cannot see to trace this area". If you want to address a specific mapper, just type the @ sign. Now a list containing all the mappers that worked in the task will pop up. Click the one you want to address and their username will be added to the comment.
