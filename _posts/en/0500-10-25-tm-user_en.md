...
The Tasking Manager Project list screen is divided into four main areas:
...
Users can download project data as a CSV file, enabling them to conduct in-depth analysis, reporting, or further processing in external tools.

#### View Projects

If you choose to show the map, you can view a map of the world showing where the projects are, or a disk indicating the number of projects in an area. Zoom in for more details, and you can select a project by clicking on its link from the map. 

![TM map][]

You can also toggle the view of the Scrollable Project List. Choose between tile view or list view.
...
+ In a comment it is possible to address specific mappers by starting with @, following by a OSM user name. Add #contributors, #author or #managers to address these.
...
If you see a validated task that does not meet the requirements it is possible to have it revalidated. Click the "Request revalidation" button above the task-comments.

The task will be reverted to the Mapped state. You should ask another validator to invalidate the task so that mappers can fix the issues and the task can be validated again.

Do not forget to add a comment to the original validator to explain why you requested revalidation.
...
[TM4-explore-page-overview]: /images/coordination/tm4_explore-page-overview.png
