...
- اینکار یک لایه اضافی برای JOSM حاوی مسیرهای GPS را دانلود می‌کند. بسته به اینکه چند مسیر توسط کاربران OSM آپلود شده است، ممکن است چندین مسیر (یا حتی بدون هرگونه مسیر) را مشاهده کنید:  
...
- بدون توجه به کادری که بالا می‌آید، لایه تصاویر را با استفاده از ماوس جابجا کنید به طوری که به نحو صحیح با مسیر GPS تراز شود. مسیرهای GPS تا حد امکان باید به محاذات جاده‌های موجود در تصویر باشند. مشاهده می‌کنید که اعداد افست در کادر تغییر می‌کنند.  
