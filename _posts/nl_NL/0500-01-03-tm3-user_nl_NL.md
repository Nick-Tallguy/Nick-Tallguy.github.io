...
4. Lees de instructies voor het project  
  ![TM Quick Start 4][]
5. Klik op de tab "Kaart"  
  ![TM Quick Start 5][]
6. Zoek naar een "aangemaakte" taak om aan te werken, klik er op en selecteer "Begin met de taak"  
  ![TM Quick Start 6][]
7. U zult worden doorgeleid naar een bewerker voor OpenStreetMap, breng alle objecten in kaart die worden vermeld in de instructies.  
  ![TM Quick Start 7][]
8. Indien het in kaart brengen is voltooid, schakel terug naar de Tasking Manager en klik ofwel op "Als voltooid markeren" als u de taak volledig in kaart hebt gebracht, of "Stoppen met in kaart brengen" als u slechts om een of andere reden wilt stoppen met het in kaart brengen.  
  ![TM Quick Start 8][]
...
De samenvatting bevat een lijst van mappers die tenminste één taak binnen het project hebben voltooid.  
...
De bewerker zal laden in een nieuw venster of tab. Potlach zal niet automatisch de begrenzing van de taak laten zien, maar dit kunt u met de volgende procedure doen:  

1. In de Tasking Manager, selecteer een taak en klik op Beginnen met deze taak om deze te vergrendelen  
2. In de Tasking Manager, klik op Bewerken met JOSM (Als er een scherm opent met de melding "JOSM remote control did not respond" klik dan gewoon op OK)  
3. Onder de knop Bewerken met JOSM, staat de volgende tekst: "Tip: Download the following .gpx file" Download dat bestand en onthoud waar het wordt opgeslagen.  
...
5. In Potlach, selecteer Background (achtergrond) en dan Vector File...  
...
7. In het venster Load Vector File, zorg er voor dat het vak in Show column voor het .gpx-bestand is geselecteerd, en sluit dan het venster  
8. Potlatch zou nu de grenzen van het gebied moeten weergeven (waarschijnlijk lichtblauw). Onthoud dat Potlach nog steeds gegevens zal laden van buiten het gebied.  
...
#### Verwijzen naar een specifieke taak bij het verzenden van een e-mail  
