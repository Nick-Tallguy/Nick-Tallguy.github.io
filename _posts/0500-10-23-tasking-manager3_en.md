...
For questions which might require a little research to answer or more thorough explanations, usually the best channel is to write to mapper-support@hotosm.org
...
All comments are public and it is not real time, live chat, use the Slack option above for realtime chat.
