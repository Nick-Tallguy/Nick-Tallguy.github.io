...
2. Click on the __Trackpoints__ button of the bottom panel to start recording track points. The button will become red. You can toggle on/off the recording process at any time by clicking on that button. The button shows the amount of the trackpoints recorded. Go for a ride! Don’t forget your smartphone
...
4. Go to the __TRACKLIST__ tab, where you will find the track you have just recorded. Tap on the track. A menu will appear. You can choose to share the track in many ways, view it using an installed external viewer, export it into /GPSLogger folder of your smartphone, or delete it from the tracklist.
